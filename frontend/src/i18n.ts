...
const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    'editor.h1': 'Редактор конфигураций',
    'editor.h1_sub': 'Редактирование конфигов Xray и Mihomo с подсказками схем.',
  ...
  en: {
    ...
    'editor.h1': 'Config Editor',
    'editor.h1_sub': 'Edit Xray and Mihomo configs with schema hints.',
