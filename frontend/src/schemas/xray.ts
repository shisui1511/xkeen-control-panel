        ...
        "rules": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "domain": { "type": "array", "items": { "type": "string" }, "description": "Domain matching list" },
    ...
    "inbounds": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "protocol": {
            "type": "string",
            "enum": ["vmess", "vless", "trojan", "shadowsocks", "socks", "http", "dokodemo-door", "mtproto"],
          ...
          "streamSettings": { "type": "object", "description": "Transport settings (TLS, WebSocket, etc.)" }
        }
      }
    },
    "outbounds": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "protocol": {
            "type": "string",
            "enum": ["vmess", "vless", "trojan", "shadowsocks", "freedom", "blackhole", "dns", "loopback"],
