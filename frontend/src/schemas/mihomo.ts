export const mihomoSchema = {
  ...
  "properties": {
    ...
    "global-client-fingerprint": {
      "type": "string",
      "enum": ["chrome", "firefox", "safari", "ios", "android", "edge", "360", "qq", "random", "none"],
    ...
    "dns": {
      ...
      "properties": {
        ...
        "default-nameserver": { "type": "array", "items": { "type": "string" }, "description": "Default DNS resolvers" },
        "enhanced-mode": {
          "type": "string",
        ...
        "nameserver": { "type": "array", "items": { "type": "string" }, "description": "Primary DNS servers" },
    ...
    "proxies": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "type": {
            "type": "string",
            "enum": ["ss", "ssr", "vmess", "vless", "trojan", "hysteria", "hysteria2", "tuic", "wireguard", "socks5", "http", "snell"],
    ...
    "proxy-groups": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "proxies": { "type": "array", "items": { "type": "string" }, "description": "Proxy names in this group" },
