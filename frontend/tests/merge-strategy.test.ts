...
// ---------------------------------------------------------------------------
test.describe('mergeXrayFile (D-04) — сохранение неуправляемых ключей', () => {
...
// D-08: объектный DNS-сервер сериализуется с полями address/port/tag/domains/skipFallback
// ---------------------------------------------------------------------------
test.describe('mergeXrayFile (D-08) — объектные DNS-серверы', () => {
...
// D-09: добавление тегированного DNS порождает dokodemo-door inbound
// ---------------------------------------------------------------------------
test.describe('mergeXrayFile (D-09) — автогенерация dokodemo-door inbound', () => {
...
// D-11: PROXY_TAG заменяется на выбранный outbound тег
// ---------------------------------------------------------------------------
test.describe('mergeXrayFile (D-11) — замена PROXY_TAG', () => {
...
// Идемпотентность: третий merge равен второму
// ---------------------------------------------------------------------------
test.describe('mergeXrayFile — идемпотентность', () => {
